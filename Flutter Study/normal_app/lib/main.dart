...
class WebViewExampleState extends State<WebViewExample> {
  ...
  Widget build(BuildContext context) {
    return WebView(
      ...
      initialUrl: 'https://akamai.wwwqa.brandap.ford.com/content/cx727/cn/zh_cn/home/mach-e.html?t=292',
      ...
      javascriptChannels: {
        JavascriptChannel(
          ...
          onMessageReceived: (JavascriptMessage message){
            print("sendPayMessage获取JS回传数据: ${message.message}");
            // _showDialog(context);
          }
        ),
        JavascriptChannel(
            ...
            onMessageReceived: (JavascriptMessage message){
              print("EVWebviewChannel获取JS回传数据: ${message.message}");
              // _showDialog(context);
            }
        )
      },
